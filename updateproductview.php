...
$productid=$_POST['updatesubmit'];
$productname=$_POST['productname'];
$productdes=$_POST['productdescription'];
$imagepath=$_POST['productimage'];
...
<form action="" method="post" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="<?php echo $productname; ?>" name="productname">
  </div>

  <div class="form-group">
    <input type="hidden"  name="productimage" value="<?php echo $imagepath?>">
    <input type="hidden"  value="<?php echo $productid;?>"   name="id">
    <input type="hidden"  value="<?php echo $productname;?>"   name="hiddenname">
    <input type="hidden"  value="<?php echo $productdes;?>"   name="hiddendes">
    <label for="product description">Product Description</label>
    <textarea class="form-control"  placeholder="<?php echo $productdes ?>"name="productdescription" aria-label="With textarea"></textarea>
   </div>
  ...
  <div class="form-group">
  <button type="submit"  name="updateproductformsubmit" class="btn btn-dark">Update Product</button>
  </div>
</form>
</div> 
